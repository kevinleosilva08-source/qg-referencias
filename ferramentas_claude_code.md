...
## FERRAMENTAS EXTERNAS CONDICIONAIS — QG decide durante o briefing

### Obrigatórias na Etapa 1 de todo projeto
| Ferramenta | URL | Quando consultar |
|-----------|-----|-----------------|
| things.co | things.co | Curadoria premium global — todo projeto |
| awwwards.com | awwwards.com | Sites premiados filtrados pelo nicho |
| land-book.com | land-book.com | Landing pages por palavra-chave |
| clicktokeep.com | clicktokeep.com | Copy fragmentado, dados de impacto — OBRIGATÓRIO |
| wairk.fr | wairk.fr | Copy de tagline e posicionamento — OBRIGATÓRIO |
| fontjoy.com | fontjoy.com | Tipografia — antes de cravar qualquer fonte |

### Condicionais por tipo de projeto
| Ferramenta | Quando usar |
|-----------|------------|
| sketchfab.com | Todo projeto com elemento 3D — arquitetura, marmoraria, produto físico |
| motionsites.ai | Hero animado em projetos React |
| getlayers.ai (extensão) | Inspecionar CSS de site de referência ou debugar ao vivo |
| lottieflow (finsweet) | Ícones e elementos animados em loop |
| lummi.ai | Banco de imagens quando Pexels não tiver imagens adequadas ao nicho |
| napkin.ai | Apresentação de proposta para cliente — fluxos e diagramas |
| mobbin.design | Portfólio pessoal, lojas virtuais, projetos React com foco em produto |
| refero.design | Mesmo que mobbin — UX de produtos SaaS reais |
| screenlane.com | Componentes específicos de UI |
| reactbits.dev | Componentes animados React |
| heropatterns.com | Texturas e fundos SVG |
| fffuel.co/nnoise | Texturas noise e gradientes |

### Referências de nicho — consultar na Etapa 1
| Nicho | Sites de referência |
|-------|-------------------|
| Estúdio criativo / Agência | sandracreates.com + heatbureau.com + wairk.fr + elimarigodesign.com + barbianaliu.com |
| Moda / Boutique / Luxo | adamjakubowski.com |
| Arquitetura / Interiores | andressarodrigues.arq.br/modern |
| Advocacia | BCR Law + GRLICA Law + Joseph Law + Hafnia Law (ver painel HTML) |

### Banco de imagens — ordem de consulta
1. **Pexels** — primeira opção universal
2. **Lummi** (lummi.ai) — quando Pexels não tiver imagens adequadas ao nicho
3. **Unsplash** — opção adicional
